<!-- top of card deck using flex-box -->
	<div class="row">
		<!-- query loop start -->
		<?php $my_query = new WP_Query( 'cat=0&posts_per_page=2' ); while ( $my_query->have_posts() ) : $my_query->the_post(); $do_not_duplicate[] = $post->ID; ?>
	...
	<div class="row">
		<?php $my_query = new WP_Query( 'cat=0&posts_per_page=3&offset=2' ); while ( $my_query->have_posts() ) : $my_query->the_post(); $do_not_duplicate[] = $post->ID; ?>
		<div class="col-lg card-deck mb-4">
			<div class="card text-white bg-info card-drop">
				<div id="post-<?php the_ID(); ?>" class="carousel vert slide" data-ride="carousel" data-interval="<?php echo rand(4500, 6000); ?>">
					<div class="carousel-inner" role="listbox">
